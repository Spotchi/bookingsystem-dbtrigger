...
import { detectLanguage, getTemplateFromLanguageCode } from "./language-utils.ts";
...
console.log("English subject:", englishTemplate.newBooking.subject("Test Booking"));
console.log("French subject:", frenchTemplate.newBooking.subject("Test Booking"));
